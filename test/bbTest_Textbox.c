...
int main(void)
{
    ...
    // bbTextbox_setMessage(textbox,message_handle1,37);
    // bbTextbox_updateBuffer(textbox);
    // bbDebug("textbox buffer:\n%s", &textbox->buffer[textbox->buffer_start]);
    //
    //
    ...
    // bbTextbox_setMessage(textbox,message_handle2,38);
    // bbTextbox_updateBuffer(textbox);
    // bbDebug("textbox buffer:\n%s\n", &textbox->buffer[textbox->buffer_start]);
    //
    // bbTextbox_hideMessage(textbox,message_handle2);
    // bbTextbox_setMessage(textbox,message_handle2,30);
