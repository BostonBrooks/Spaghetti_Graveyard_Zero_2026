...
bbFlag bbAgent_newFireball(bbAgent** self, bbMapCoords MC,bbMapCoords goalpoint,  I32 moveable_index, I32 entity_index)
{
...
bbFlag bbUnit_newFireball(bbUnit** self, bbMapCoords MC, I32 moveable_index, I32 entity_index)
{
...
bbFlag bbSF_fireballGraphics(I32 i_coord, I32 j_coord, I32 moveable_index, I32 entity_index)
{
    ...
    MC.k = bbMapCoords_getElevation(&home.ground_surface, MC);
    bbUnit* unit;
    bbUnit_newFireball(&unit, MC, moveable_index, entity_index);
    return bbSuccess;
}



bbFlag bbSF_fireballCore(I32 i_coord, I32 j_coord, I32 moveable_index, I32 entity_index)
{
    bbMapCoords MC;
    MC.i = i_coord;
    MC.j = j_coord;
    MC.k = bbMapCoords_getElevation(&home.ground_surface, MC);
    bbAgent* agent;
    bbAgent_newFireball(&agent, MC,MC, moveable_index, entity_index);
}

///Spawn fireball during gameplay, doesn't care about syncing the core

bbFlag bbEntity_newFireball(bbAgent** agent, I32 type_index, bbMapCoords MC,bbMapCoords MC2, I32 moveable_index, I32 entity_index)
{
    bbAgent* agent1;
    bbAgent_newFireball(&agent1, MC, MC2,moveable_index, entity_index);
...
bbFlag bbUIUnit_newFireball( bbMapCoords MC, I32 moveable_index, I32 entity_index)
{
    bbUnit* unit;
    bbUnit_newFireball(&unit,MC, moveable_index, entity_index);
