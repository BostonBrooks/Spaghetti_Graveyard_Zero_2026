...
bbFlag bbUnit_newSkelly(bbUnit** self, bbMapCoords MC, I32 moveable_index, I32 entity_index)
{
...
bbFlag bbSF_skellyGraphics(I32 i_coord, I32 j_coord, I32 moveable_index, I32 entity_index)
{
    ...
    MC.k = bbMapCoords_getElevation(&home.ground_surface, MC);
    bbUnit* unit;
    bbUnit_newSkelly(&unit, MC, moveable_index, entity_index);
    return bbSuccess;
}
...
bbFlag bbSF_skellyCore(I32 i_coord, I32 j_coord, I32 moveable_index, I32 entity_index)
{
    ...
    MC.k = bbMapCoords_getElevation(&home.ground_surface, MC);
    bbAgent* agent;
    bbAgent_newSkelly(&agent, MC, moveable_index, entity_index);
}
...
{
    bbAgent* agent1;
    bbAgent_newSkelly(&agent1, MC, moveable_index, entity_index);
